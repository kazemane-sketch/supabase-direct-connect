    ...
    <aside className="w-60 min-h-screen bg-sidebar flex flex-col border-r border-sidebar-border shrink-0">
      <div className="px-5 py-6">
        <h1 className="text-xl font-bold text-sidebar-primary-foreground tracking-tight">
          <span className="text-sidebar-primary">Fin</span>Flow
        </h1>
        <p className="text-xs text-sidebar-muted mt-0.5">Gestione finanziaria PMI</p>
      </div>
      ...
      <div className="px-5 py-4 border-t border-sidebar-border">
        <p className="text-xs text-sidebar-muted">FinFlow v1.0</p>
      </div>
    </aside>
  );
}
